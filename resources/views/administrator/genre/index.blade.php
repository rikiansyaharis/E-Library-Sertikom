        ...
        <div class="row">
            <div class="col-12">
                <div class="page_title_box d-flex align-items-center justify-content-between">
                    ...
                    <a href="{{ route('admin.genres.create')}}" class="white_btn3">Tambah Genre</a>
                </div>
            </div>
        </div>
                                    ...
                                    <table class="table  ">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $item->name }}</td>
                                                <td>
                                                    <a href="{{ route('admin.genres.edit', $item->id )}}" class="btn btn-outline-info "><i class="fas fa-edit"></i></a>
                                                    <a href="{{ route('admin.genres.delete', $item->id )}}" onclick="return confirm('Apa anda ingin menghapus genre ini?');" class="btn btn-outline-danger"><i class="fas fa-trash"></i></a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
